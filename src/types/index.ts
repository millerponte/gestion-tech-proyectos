...
export interface CitaVentas { id: string; cliente: string; empresa?: string; contacto: string; correo: string; cargo: string; sector: SectorCita; fechaReunion: string; horario: string; solucion: string; observaciones: string; statusProyecto: string; status: 'pendiente' | 'realizado' | 'cancelado' | 'vencido'; createdAt: string; }
export interface FirmaVentas { id: string; cliente: string; telefono?: string; autorizadoPor: string; documento: string; empresa: string; fecha: string; firmadoPor: string; tipoFirma: TipoFirma; nombreProyecto: string; enviadoPor: string; codigo: string; observaciones: string; estado?: string; historialStatus?: HistorialNota[]; createdAt: string; esPendiente?: boolean; pendienteFechaInicio?: string; pendienteFechaLimite?: string; fechaPendienteResuelto?: string; historialPendientes?: HistorialNota[]; }
