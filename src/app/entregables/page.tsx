...
import { FileText, Plus, Search, Filter, Download, ChevronDown, ChevronUp, Pencil, Trash2, Check, X, Mail } from 'lucide-react'
...
const [loadingHitosEdicion, setLoadingHitosEdicion] = useState(false)
  ...
  const [entregableSubsanar, setEntregableSubsanar] = useState<Entregable | null>(null)
